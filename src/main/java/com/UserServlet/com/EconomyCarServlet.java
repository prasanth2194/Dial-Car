...
/**
 * Servlet implementation class EconomyCarServlet
 */
public class EconomyCarServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EconomyCarServlet() {
        super();
	...
	//	response.getWriter().append("Served at: ").append(request.getContextPath());
       ...
       // out.print("<table border='1' callspacing='10px' align='center' margin-top='300px' margin-left='100px'>");
        ...
        for(Car e:list){  
         out.println("<tr><td>");
         out.println(e.getCar_id()+"</td><td>"+e.getCarname()+"</td><td>"+e.getDescrption()+"</td><td>"+e.getType()+"</td><td>"+e.getPrice_km()+"</td><td>"+e.getStatus()+ "</td><td><a href=bookcar.jsp?car_id="+e.getCar_id()+">BOOKCAR</a></td>");       
         out.println("</tr></td>");
