...
/**
 * Servlet implementation class ViewUltraCar
 */
public class ViewUltraCar extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Car> list =impl.ViewUltraCar();
        ...
        for(Car e:list){  
         out.println("<tr><td>");
         out.println(e.getCar_id()+"</td><td>"+e.getCarname()+"</td><td>"+e.getDescrption()+"</td><td>"+e.getType()+"</td><td>"+e.getPrice_km()+"</td><td>"+e.getStatus()+ "</td><td><a href=bookcar.jsp?car_id="+e.getCar_id()+">BOOKCAR</td></a>");
         out.println("</tr></td>");
